...
print(f"\nSetup: {analysis_size=}, {synthesis_size=}, {hop_ratio=}, {gain_compensation=}")
...
for n in range(0, signal_in.shape[0] - fft_size, analysis_size):
    ...
    # Add processed data
    m = round(n * stretch_amount)
    signal_out[m:m + fft_size] += block
